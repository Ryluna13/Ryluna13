...
public class PessoaController {
    public static void cadastra(ArrayList<PessoaModel> pessoas){
        ...
        System.out.println("--------------------------------");
        System.out.println("------ Cadastro de Usario  -----");
        System.out.println("--------------------------------");
        ...
        System.out.print("Senha (Precisa Ter um Caractere Special e Um Numero (ex:%&!@#$): ");
        pessoa.setSenha(get.nextLine());
    ...
    private static String pessoaToString(PessoaModel p ){
        return "Nome: " + p.nome + " - Sexo: "  + p.sexo + "Senha" + p.senha + " - Idade: " + p.idade;
    }
